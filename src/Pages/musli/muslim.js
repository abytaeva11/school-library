                    ...
                    <div className="musa">
                        <div className="musa-block flex">
                            ...
                            <div className="musa-img">
                                ...
                                <h5>09.09.22</h5>
                                <p className='flex items-center mt-0'><AiFillStar className='text-yellow-500'/>
                                    <AiFillStar className='text-yellow-500'/> <AiFillStar className='text-yellow-500'/>
                                    <AiFillStar className='text-yellow-500'/> <AiFillStar className='text-yellow-500'/>
                                    <AiFillStar className='text-yellow-500'/> <AiFillStar className='text-yellow-500'/>
                                    <AiFillStar className='text-yellow-500'/> <AiFillStar
                                        className='text-yellow-500 mr-2'/>10 / 10</p>
                            </div>
                        </div>
                    ...
                    <div className="musa">
                                <div className="musa-block flex">
                                    ...
                                    <div className="musa-img">
                                        ...
                                        <p className='flex items-center mt-0'><AiFillStar className='text-yellow-500'/>
                                            <AiFillStar className='text-yellow-500'/> <AiFillStar
                                                className='text-yellow-500'/> <AiFillStar className='text-yellow-500'/>
                                            <AiFillStar className='text-yellow-500'/> <AiFillStar
                                                className='text-yellow-500'/> <AiFillStar className='text-yellow-500'/>
                                            <AiFillStar className='text-yellow-500'/> <AiFillStar
                                                className='text-yellow-500 mr-2'/>10 / 10</p>
